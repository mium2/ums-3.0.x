...
public abstract class BaseKkoFrtSendService {
    protected Logger logger = LoggerFactory.getLogger(this.getClass().getName());
    @Autowired(required = true)
    protected FriendtalkWorkerMgrPool friendtalkWorkerMgrPool;
    @Autowired(required = true)
    protected LgcnsKkoFrtSendService lgcnsKkoFrtSendService;
    @Autowired(required = true)
    ...
    /**
     * UMS발송에서 등록되는 친구톡 발송일감 처리 등록.
     * UMS UI 발송: (T_UMS_SEND)원장 저장 테이블.
     * @param users
     * @param umsSendMsgBean
     * @return
     */
    public abstract void umsKkoFriendTolkSend(final Map<String,List<String>> users, final UmsSendMsgBean umsSendMsgBean, Map<String,Map<String,String>> cuidVarMap, boolean isDaeCheSend) throws Exception;
     ...
     * @return
     */
    public abstract void umsKkoFriendTolkSend(final PushEachProcessBean pushEachProcessBean, final UmsSendMsgBean umsSendMsgBean) throws Exception;
     ...
     * @return
     */
    public void umsKkoFriendTolkSend(final Map<String, List<String>> users, final UmsSendMsgBean umsSendMsgBean, boolean isDaeCheSend) throws Exception{
        umsKkoFriendTolkSend(users,umsSendMsgBean,null,isDaeCheSend);
    }
     ...
     * @return
     */
    public void umsKkoFriendTolkSend(final PushEachProcessBean pushEachProcessBean) throws Exception{
        ...
        //푸시 개별발송 실패 친구톡 대체발송
        umsKkoFriendTolkSend(pushEachProcessBean,umsSendMsgBean);
    }
